...
print(
    f"{name} liked to hum the song {song} while coding. It was so annoying that their teammates would throw {food} unril {name} would stop singing"
)
...
print(type(num1))
print(type(num2))
#python knows alor of number types
#floats deal with decimal numbers
num3 = 3.14
print(num3)
print(type(num3))
#explicit types
...
siblings_age = input(" How old is your sibling? ")
...
new_points= 1
total_points= 22
print( "You have earned {} points! In total, you have accumulated {}} points" .format(new_points, total_points))
